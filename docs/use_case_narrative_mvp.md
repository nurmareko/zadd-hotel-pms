...
- **Administrator** — the supervising lecturer, responsible for master data and user accounts, with access to the shared HK board, assignment, inspection, status override, Daily List print, room history, and linen circulation.
...
| Administrator | Manage Master Data; Manage Restaurant Tables (`/app/admin/tables`); Arrange Table Floor Layout; Manage Users & Roles; View Room Board; Assign Rooms; Bulk Assign Rooms; Inspect VCU Room; Override Room Status; Print Daily List; View Room History; Manage Linen Circulation (view KPIs, search/filter, dispatch, advance to washing, receive/reconcile once) (no cleaning or Lost & Found access) |
