...
function FilterAndAddBarSkeleton() {
  return (
    <section className="mb-4 border border-console-border bg-console-surface">
      <div className="flex flex-wrap items-center gap-2 border-b border-console-border p-3.5">
        <Skeleton className="h-8 w-full border border-console-border sm:w-[300px]" />
        <Skeleton className="h-8 w-full border border-console-border sm:w-[110px]" />
        <Skeleton className="h-8 w-full border border-console-border sm:w-[150px]" />
        <Skeleton className="h-8 w-20 border border-console-border bg-console-ink" />
      ...
      <div className="grid gap-2 p-3.5 md:grid-cols-[minmax(220px,1fr)_150px_auto]">
        ...
        <Skeleton className="h-8 border border-console-border" />
        <Skeleton className="h-8 w-full border border-console-border bg-console-ink md:w-32" />
      </div>
    </section>
  );
}
