  ...
  return (
    <section className="mb-4 rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div className="flex flex-wrap items-center gap-2 border-b border-slate-200 p-3.5">
        ...
        <Skeleton className="h-8 w-20 rounded-xl border border-slate-200 bg-slate-900 shadow-sm" />
      ...
      <div className="grid gap-2 p-3.5 md:grid-cols-[minmax(220px,1fr)_150px_auto]">
        ...
        <Skeleton className="h-8 border border-slate-200" />
        <Skeleton className="h-8 w-full rounded-xl border border-slate-200 bg-slate-900 shadow-sm md:w-32" />
      </div>
    </section>
  );
}
