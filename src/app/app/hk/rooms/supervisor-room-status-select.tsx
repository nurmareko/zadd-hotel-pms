    ...
    <div className="min-w-[190px]">
      ...
      <div className="relative">
        <select
          ...
          className="h-11 w-full appearance-none rounded-md border border-border bg-background px-2 pr-8 text-xs font-semibold text-foreground outline-none transition-colors hover:bg-accent focus:border-ring focus:ring-2 focus:ring-ring/20 disabled:cursor-wait disabled:opacity-50 desktop:h-10"
        >
